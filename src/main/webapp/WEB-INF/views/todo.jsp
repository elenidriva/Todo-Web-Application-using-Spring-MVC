     				...
     				<div class="form-group text-center">
        				<div class="form-group">
        					...
        					<p>Priority :  
       	 					...
       	 					<p>Due in : <input type="text"  id = "targetDate" name = "targetDate" class="form-control" value ="${targetDate}" placeholder=" Please follow this format: mm/dd/yyyy" required="required" /> </p>
